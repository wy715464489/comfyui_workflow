...
验证角色立绘工作流（头部 XL + 全身 XL）
用法：python test/test_character.py
"""
...
# 需要验证的工作流
WORKFLOWS = [
    ("workflows/character/portrait_head_xl.json",     "头部立绘 XL (1024×1024)", 300),
    ("workflows/character/portrait_fullbody_xl.json", "全身立绘 XL (832×1216)",  300),
]
